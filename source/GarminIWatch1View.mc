...
function drawStat(stat, dc, settings, bitmapIcons){
	...
	if (stat.equals("floorsClimbed")){
		dc.drawBitmap(settings["floors_climbed"]["x"], 
			settings["floors_climbed"]["y"], 
...
class GarminIWatch1View  extends WatchUi.WatchFace {
	var settings = {
		"batt_status"=> {"high"=> 70, "low"=> 30, "x"=> .43, "y"=> .05},
		"floors_climbed" => {"x"=> 184, "y"=> 90},
		"bluetooth" => {"x"=> .7, "y"=> .15},
		"daily_monitor" => [],
